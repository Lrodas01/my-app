...
import SpecificJobs from './Pages/SpecificJobs';
 import Interviews from './Pages/TabPages/Interviews';
import ActualHome from '../app/Pages/TabPages/HomePage'
import Search from '../app/Pages/TabPages/Search'
...
const App = () => {
  const handlePress = () => {
    router.navigate('/Pages/TabPages/HomePage')
  }
  return (
      // <View>
      //   <TouchableOpacity onPress={handlePress}>
      //     <Text>Head to welcome</Text>
      //   </TouchableOpacity>
      // </View>
