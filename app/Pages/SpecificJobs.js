...
const SpecificJobs = ({ route, navigation }) => {
  ...
  const { job, colleges, collegesImage } = route.params;
...
<View style = {styles.benefitsContainer}>
    ...
    <View style = {styles.benefitsDescriptionContainer}>
        <View style = {styles.salaryBox}>
          ...
          <Text style = {styles.titleSalary}>79K - 140K</Text>
          <Text style = {styles.descriptionSalary}>How much would you make?</Text>
        </View>
    ...
    <View style = {styles.collegeContainer}>
          ...
          <Text style={styles.collegeText}>What colleges recommend this career? </Text>

    <View style={{ flexDirection: 'row', top: 110,}}> 
        {colleges.map((college, index) => (
          <Colleges key={index} collegeName={college.collegeName} collegeImage = {college.collegeImage} />
        ))}
        </View>
    </View>    
        ...
        <View style = {styles.programContainer}>
          <Text style={styles.programsText}>Programs or Interships to join (websites)</Text>
        <Pressable style = {styles.programsButton} onPress = {() => navigation.navigate('Programs', {job})}>
